...
parser.add_argument('--t_model', type=str, default='', help='path name of teacher model')
...
parser.add_argument('--note', type=str, default='resnet110-20-gs', help='note for this run')

# net and dataset choosen
parser.add_argument('--data_name', type=str, default='cifar100', help='name of dataset')
parser.add_argument('--t_name', type=str, default='', help='name of teacher')
parser.add_argument('--s_name', type=str, default='', help='name of student')

# hyperparameter
parser.add_argument('--kd_mode', type=str, default='', help='mode of kd, which can be:'
...
def train(train_loader, nets, optimizer, criterions, epoch):
	...
	for i, (img, target) in enumerate(train_loader, start=1):
		...
		_, _, _, out_s = snet(img)
		_, _, _, out_t = tnet(img)
